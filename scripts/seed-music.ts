...
const client = buildClient({ apiToken: "***REMOVED***" });
...
async function main() {
  ...
  const bluesId = await createNode({
    title: "Blues",
    slug: "blues",
    color: hex("#1565C0"),
    year: 1900,
  ...
  await createNode({ title: "Mamie Smith registra Crazy Blues", slug: "mamie-smith-crazy-blues", parent_id: bluesId, year: 1920, visibility: "super", event_type: "key_moment",
  ...
  await createNode({ title: "Bessie Smith — Downhearted Blues", slug: "bessie-smith-downhearted-blues", parent_id: bluesId, year: 1923, visibility: "super", event_type: "key_moment",
    featured_image: img(imgBessie),
  ...
  await createNode({ title: "Robert Johnson — Sessioni di Dallas", slug: "robert-johnson-dallas-sessions", parent_id: bluesId, year: 1936, visibility: "super", event_type: "key_moment",
  ...
  await createNode({ title: "Muddy Waters elettrifica il blues a Chicago", slug: "muddy-waters-chicago", parent_id: bluesId, year: 1948, visibility: "main", event_type: "key_moment",
  ...
  await createNode({ title: "B.B. King — 3 O'Clock Blues", slug: "bb-king-3-oclock-blues", parent_id: bluesId, year: 1951, visibility: "main", event_type: "key_moment",
  ...
  await createNode({ title: "Louis Armstrong — Hot Five", slug: "louis-armstrong-hot-five", parent_id: jazzId, year: 1925, visibility: "super", event_type: "key_moment",
    featured_image: img(imgArmstrong),
  ...
  await createNode({ title: "Duke Ellington al Cotton Club", slug: "duke-ellington-cotton-club", parent_id: jazzId, year: 1927, visibility: "super", event_type: "key_moment",
  ...
  await createNode({ title: "Charlie Parker e la rivoluzione Bebop", slug: "charlie-parker-bebop", parent_id: jazzId, year: 1945, visibility: "super", event_type: "key_moment",
  ...
  await createNode({ title: "Miles Davis — Kind of Blue", slug: "miles-davis-kind-of-blue", parent_id: jazzId, year: 1959, visibility: "super", event_type: "key_moment",
  ...
  await createNode({ title: "John Coltrane — A Love Supreme", slug: "john-coltrane-a-love-supreme", parent_id: jazzId, year: 1964, visibility: "main", event_type: "key_moment",
  ...
  await createNode({ title: "Chuck Berry — Maybellene", slug: "chuck-berry-maybellene", parent_id: rockId, year: 1955, visibility: "super", event_type: "key_moment",
  ...
  await createNode({ title: "Elvis Presley — Heartbreak Hotel", slug: "elvis-presley-heartbreak-hotel", parent_id: rockId, year: 1956, visibility: "super", event_type: "key_moment",
    featured_image: img(imgElvis),
  ...
  await createNode({ title: "The Beatles — British Invasion", slug: "the-beatles-british-invasion", parent_id: rockId, year: 1964, visibility: "super", event_type: "key_moment",
  ...
  await createNode({ title: "Jimi Hendrix — Are You Experienced", slug: "jimi-hendrix-are-you-experienced", parent_id: rockId, year: 1967, visibility: "super", event_type: "key_moment",
  ...
  await createNode({ title: "Led Zeppelin — Album di debutto", slug: "led-zeppelin-debut", parent_id: rockId, year: 1969, visibility: "main", event_type: "key_moment",
  ...
  await createNode({ title: "Ray Charles — I Got a Woman", slug: "ray-charles-i-got-a-woman", parent_id: soulId, year: 1954, visibility: "super", event_type: "key_moment",
  ...
  await createNode({ title: "Fondazione della Motown Records", slug: "motown-records-fondazione", parent_id: soulId, year: 1959, visibility: "main", event_type: "key_moment",
  ...
  await createNode({ title: "James Brown — Papa's Got a Brand New Bag", slug: "james-brown-papas-got-a-brand-new-bag", parent_id: soulId, year: 1965, visibility: "super", event_type: "key_moment",
  ...
  await createNode({ title: "Aretha Franklin — Respect", slug: "aretha-franklin-respect", parent_id: soulId, year: 1967, visibility: "super", event_type: "key_moment",
    featured_image: img(imgAretha),
  ...
  await createNode({ title: "Marvin Gaye — What's Going On", slug: "marvin-gaye-whats-going-on", parent_id: soulId, year: 1971, visibility: "super", event_type: "key_moment",
  ...
  const hipHopId = await createNode({
    title: "Hip-Hop",
    slug: "hip-hop",
    color: hex("#EA580C"),
    year: 1973,
  ...
  await createNode({ title: "DJ Kool Herc — La Prima Festa", slug: "dj-kool-herc-prima-festa", parent_id: hipHopId, year: 1973, month: 8, day: 11, visibility: "super", event_type: "key_moment",
    featured_image: img(imgHerc),
  ...
  await createNode({ title: "Sugarhill Gang — Rapper's Delight", slug: "sugarhill-gang-rappers-delight", parent_id: hipHopId, year: 1979, visibility: "super", event_type: "key_moment",
  ...
  await createNode({ title: "Grandmaster Flash — The Message", slug: "grandmaster-flash-the-message", parent_id: hipHopId, year: 1982, visibility: "super", event_type: "key_moment",
  ...
  await createNode({ title: "Run-DMC — Raising Hell", slug: "run-dmc-raising-hell", parent_id: hipHopId, year: 1986, visibility: "main", event_type: "key_moment",
  ...
  await createNode({ title: "Public Enemy — It Takes a Nation of Millions", slug: "public-enemy-it-takes-a-nation", parent_id: hipHopId, year: 1988, visibility: "main", event_type: "key_moment",
  ...
  const electroId = await createNode({
  ...
  await createNode({ title: "Kraftwerk — Autobahn", slug: "kraftwerk-autobahn", parent_id: electroId, year: 1974, visibility: "super", event_type: "key_moment",
    featured_image: img(imgKraftwerk),
  ...
  await createNode({ title: "Giorgio Moroder — I Feel Love", slug: "giorgio-moroder-i-feel-love", parent_id: electroId, year: 1977, visibility: "super", event_type: "key_moment",
  ...
  await createNode({ title: "Frankie Knuckles — House Music a Chicago", slug: "frankie-knuckles-house-chicago", parent_id: electroId, year: 1984, visibility: "super", event_type: "key_moment",
  ...
  await createNode({ title: "Detroit Techno — Le Belleville Three", slug: "detroit-techno-belleville-three", parent_id: electroId, year: 1987, visibility: "main", event_type: "key_moment",
  ...
  await createNode({ title: "Daft Punk — Homework", slug: "daft-punk-homework", parent_id: electroId, year: 1997, visibility: "main", event_type: "key_moment",
